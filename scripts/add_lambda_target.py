...
def add_curator_lambda_target(lambda_arn):
            ...
            "inlinePayload": [
                {
                    ...
                    "description": "Fetch and analyze all vulnerability findings from AWS Inspector2",
                    "inputSchema": {
                        "type": "object",
                        "properties": {},
                    },
    ...
    gateway = {"gatewayId": gateway_id, "mcp_url": gateway_config["mcp_url"]}
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        print(
            "Example: python add_lambda_target_simple.py arn:aws:lambda:us-east-1:123456789012:function:my-function"
        )
        sys.exit(1)
